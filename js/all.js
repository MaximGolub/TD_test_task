		...
		(c.VERSION = "3.3.7"),
			...
			(c.prototype.getItemForDirection = function (a, b) {
				var c = this.getItemIndex(b),
					d =
						("prev" == a && 0 === c) || ("next" == a && c == this.$items.length - 1);
			...
			(g.prototype.toggle = function (d) {
				...
				if (!e.is(".disabled, :disabled")) {
					...
					if ((c(), !g)) {
						...
						if (
							(f.trigger((d = a.Event("show.bs.dropdown", h))), d.isDefaultPrevented())
						)
							return;
				...
				(e.prototype.isVisible = function (a) {
					...
					return (
						...
						(f =
							...
							window.pageYOffset),
						(e =
							f + Math.min(this.element.clientHeight, this.util().innerHeight()) - c),
						(d = this.offsetTop(a)),
						(b = d + a.clientHeight),
						e >= d && b >= f
					);
		...
		var t,
			...
			g = function (e, t) {
				...
				return (
					...
					"easeInOutQuad" === e && (n = 0.5 > t ? 2 * t * t : -1 + (4 - 2 * t) * t),
					"easeInCubic" === e && (n = t * t * t),
					"easeOutCubic" === e && (n = --t * t * t + 1),
					"easeInOutCubic" === e &&
						(n = 0.5 > t ? 4 * t * t * t : (t - 1) * (2 * t - 2) * (2 * t - 2) + 1),
		...
		(e.fn.prettyPhoto = function (a) {
					...
					$pp_pic_holder.animate(
						{
							top: projectedTop,
							left:
								j / 2 - f.containerWidth / 2 < 0 ? 0 : j / 2 - f.containerWidth / 2,
			...
			function u() {
				...
				settings.slideshow &&
					...
					$pp_pic_holder
						...
						.bind("click", function () {
							return (
								e.prettyPhoto.changePage("previous"), e.prettyPhoto.stopSlideshow(), !1
							);
						}),
					$pp_pic_holder
						...
						.bind("click", function () {
							return (
								e.prettyPhoto.changePage("next"), e.prettyPhoto.stopSlideshow(), !1
							);
						}),
					c();
			}
			...
			return (
				...
				!pp_alreadyInitialized &&
					...
					setTimeout(function () {
						e("a[" + a.hook + "^='" + hashRel + "']:eq(" + hashIndex + ")").trigger(
							"click"
						);
					}, 50)),
...
!(function (t, e, i, s) {
	...
	var n = "stellar",
		...
		c = f("transform"),
		p =
			t("<div />", { style: "background:#fff" }).css("background-position-x") !==
			s,
		h = p
			? function (t, e, i) {
				...
				this.options.parallaxElements &&
					this.$element.find("[data-stellar-ratio]").each(function () {
						...
						e.options.showElement(h),
							...
							(l =
								"auto" === h.css("margin-top") ? 0 : parseInt(h.css("margin-top"), 10)),
							(c = h.offset().left - a),
							(p = h.offset().top - l),
				...
				this.options.parallaxBackgrounds &&
					...
					e.each(function () {
						...
						u.data("stellar-backgroundStartingLeft")
							...
							(l =
								"auto" === u.css("margin-top") ? 0 : parseInt(u.css("margin-top"), 10)),
							(f = u.offset().left - a - o),
							(c = u.offset().top - l - n),
						...
						this.options.hideDistantElements &&
							((u =
								...
								(a + t.width > (t.isFixed ? 0 : c) &&
									a <
										(t.isFixed ? 0 : c) + this.viewportWidth + this.viewportOffsetLeft)),
							(d =
								!this.options.verticalScrolling ||
								(l + t.height > (t.isFixed ? 0 : p) &&
									l <
										(t.isFixed ? 0 : p) + this.viewportHeight + this.viewportOffsetTop))),
						u && d
							? (t.isHidden &&
			...
			(c = c === d ? this._items.length : this.normalize(c, !0)),
				...
				0 === this._items.length || c === this._items.length
					? (0 === this._items.length && this.$stage.append(b),
					  ...
					  this._items.push(b),
					  this._mergers.push(
							1 * b.find("[data-merge]").andSelf("[data-merge]").attr("data-merge") ||
								1
					  ))
	...
	(i.Isotope.settings = {
		...
		(i.fn.imagesLoaded = function (t) {
			...
			function e(t) {
				...
				n.src !== a &&
					-1 === i.inArray(n, h) &&
					(h.push(n), --r <= 0 && (setTimeout(s), o.unbind(".imagesLoaded", e)));
			}
			var n = this,
				...
				if (
						...
						d.val() ||
							...
							(0 === f.filter(".active").length &&
								...
								(f = g.options.liveSearchNormalize
									? f.filter(":a" + g._searchStyle() + "(" + b(q[c.keyCode]) + ")")
									: f.filter(":" + g._searchStyle() + "(" + q[c.keyCode] + ")"))))),
					f.length)
				) {
					if (/(38|40)/.test(c.keyCode.toString(10)))
						...
						f.each(function () {
							a(this).parent().hasClass("disabled") ||
								(a.trim(a(this).text().toLowerCase()).substring(0, 1) == q[c.keyCode] &&
					...
					if (
						(/(13|32)/.test(c.keyCode.toString(10)) ||
							(/(^9$)/.test(c.keyCode.toString(10)) && g.options.selectOnTab)) &&
						o
					) {
						if (
